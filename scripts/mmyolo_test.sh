...
# test - synth
python 3rdparty/mmyolo/tools/test.py \
    $cfg_path \
    $best_model_path \
    --work-dir runs/mmyolo/$exp_name/test \
    --out runs/mmyolo/$exp_name/test/coco_detection/prediction_test_synth.pkl \
    --cfg-options \
    test_evaluator.outfile_prefix=runs/mmyolo/$exp_name/test/coco_detection/prediction_test_synth
...
python 3rdparty/mmyolo/tools/test.py \
    ...
    $best_model_path \
    --work-dir runs/mmyolo/$exp_name/test \
    --out runs/mmyolo/$exp_name/test/coco_detection/prediction_test_real_nominal.pkl \
    --cfg-options \
    ...
    test_evaluator.outfile_prefix=runs/mmyolo/$exp_name/test/coco_detection/prediction_test_real_nominal
...
python 3rdparty/mmyolo/tools/test.py \
    ...
    $best_model_path \
    --work-dir runs/mmyolo/$exp_name/test \
    --out runs/mmyolo/$exp_name/test/coco_detection/prediction_test_real_edge.pkl \
    --cfg-options \
    ...
    test_evaluator.outfile_prefix=runs/mmyolo/$exp_name/test/coco_detection/prediction_test_real_edge
...
python 3rdparty/mmyolo/tools/test.py \
    ...
    $best_model_path \
    --work-dir runs/mmyolo/$exp_name/test \
    --out runs/mmyolo/$exp_name/test/coco_detection/prediction_test_real.pkl \
    --cfg-options \
    ...
    test_evaluator.outfile_prefix=runs/mmyolo/$exp_name/test/coco_detection/prediction_test_real
...
python 3rdparty/mmyolo/tools/test.py \
    ...
    $best_model_path \
    --work-dir runs/mmyolo/$exp_name/test \
    --out runs/mmyolo/$exp_name/test/coco_detection/prediction_test.pkl \
    --cfg-options \
    ...
    test_evaluator.outfile_prefix=runs/mmyolo/$exp_name/test/coco_detection/prediction_test
